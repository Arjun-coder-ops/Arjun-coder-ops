...
# ===========================================================================
HOST = "Arjun-coder-ops"   # shown as  Arjun-coder-ops@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "MERN Full Stack Developer & DevOps Engineer"),
    ("kv", "Focus", "CI/CD, Automation, Full-Stack SaaS & Cloud Architecture"),
    ("kv", "Edu", "Computer Science"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, HTML, CSS, JavaScript, Redux"),
    ("kv", "Backend", "Node.js, Express, Python, Go"),
    ("kv", "Database", "MongoDB, PostgreSQL, Redis"),
    ("kv", "DevOps", "Docker, Kubernetes, GitHub Actions, Terraform, AWS"),
    ("kv", "AI / ML", "LangChain, Gemini API, AI Agents"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Automated Profile README Generator using Python & SVGs"),
    ("bul", "CI/CD Pipelines optimizing build and deploy times"),
    ("bul", "AI Coding Assistant plugins and agentic integrations"),
]
