...
ROWS = [
    ("host",),
    ("kv", "Now", "DevOps Engineer & Full Stack Developer"),
    ("kv", "Focus", "CI/CD, Automation, AI Agents & Cloud Architecture"),
    ("kv", "Edu", "Computer Science"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "HTML, CSS, JavaScript, React"),
    ("kv", "Backend", "Python, Node.js, Bash, Go"),
    ("kv", "DevOps", "Docker, Kubernetes, GitHub Actions, Terraform"),
    ("kv", "AI / ML", "LangChain, Gemini API, AI Agents"),
    ("kv", "Cloud", "AWS, GCP, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
